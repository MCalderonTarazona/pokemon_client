      ...
      <Link className={style.registerForm} to="/">Back</Link>  
        <div className={style.containerLogin}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <p className={style.errorForm}>{errors.email ? errors.email : <div className={style.space}>&nbsp;</div>}</p>
            <h2>Password</h2>
            ...
            <p className={style.errorForm}>{errors.password ? errors.password : <div className={style.space}>&nbsp;</div>}</p>
            <div className={style.containerButton}>
                { !errors.name && !errors.email && !errors.password && errors.name !== ""
